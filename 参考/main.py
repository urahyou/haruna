...
# 参考文档 ： https://www.riverbankcomputing.com/static/Docs/PyQt5/api/qtwidgets/qwidget.html?highlight=setwindowflags##setWindowFlags
...
class DesktopPet(QWidget):
    ...
    def initPall(self):
        ...
        # ------------------ 
        # 显示天气
        getWeather = QAction('天气', self, triggered=self.getWeather)
        # ------------------
        ...
        # 这个被添加到了托盘的菜单栏
        self.tray_icon_menu.addAction(getWeather)
    ...
    def initPetImage(self):
        ...
        self.pic = QPixmap('surface0000.png')
        self.mymask = QBitmap('mymask.png')
    ...
    def contextMenuEvent(self, event):
        ...
        if action == myWeather:
            myWeather = self.getWeather()
            qmb = QMessageBox(self)
            qmb.setModal(False)
            qmb.move(self.x()+200, self.y())
            qmb.setWindowTitle('天气预报')
            qmb.setText('<h2>广州天气</h2>')
            qmb.setInformativeText('气温范围：{}\n天气：{}\n '.format(myWeather['temp_range'], myWeather['cloud']))
